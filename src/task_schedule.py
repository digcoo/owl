...
#    if not CacheData.is_market_open():
#        return
...
@scheduler.scheduled_job('cron', id='stock_day_inc_spider', minute='19', day_of_week='0-4', hour='20')
...
@scheduler.scheduled_job('cron', id='stock_day_realtime_spider', second='*/60', day_of_week='0-4', hour='9-14', max_instances=1)
