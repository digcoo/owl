...
#                    continue
    ...
    def cache_hist_months(self, symbols):
        ...
        return CacheData.hist_months


    #缓存历史日分时交易数据
    def cache_hist_times(self, symbols):
	if CacheData.hist_times is not None:
	    return CacheData.hist_times
...
#	    break
	...
	CacheData.hist_times = ParseUtil.compose_stock_times_from_daytimes_map(allstocks_latest_times)
